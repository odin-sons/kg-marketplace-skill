...
- `[Section]` starts a new profile/block. Spacing and capitalization inside brackets don't matter — **except** Territories and Leaderboard Achievements, where the header is case-sensitive and keeps spaces literally.
